...
export default function Phrases() {
  ...
  useEffect(() => {
    ...
    return (
      <>
        <div className="flex flex-row pt-[14%] justify-center text-center">
        ...
        <div className="flex flex-col justify-center pt-5">
          <strong><p className="text-cyan-800 text-center text-2xl font-proxima">[ Software Engineer ]</p></strong>
        </div>
        </>
    );
  }